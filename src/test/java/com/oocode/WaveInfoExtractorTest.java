...
public class WaveInfoExtractorTest {
    ...
    @Test
    public void extractsWaveInfoFromCsv() throws IOException, CsvException {
        String waveCsvData = """
        ...
        assertThat(extractedWaveInfo, equalTo(expectedWaveInfo));
    }

    @Test
    public void extractsWaveInfoFromCsvMultipleLocations() throws IOException, CsvException {
        String waveCsvData = """
                    Wave Data provided @ 02:15hrs on 28-04-2024
                    Site, SiteNumber, Seconds, DateTime, Latitude, Longitude, Hsig, Hmax, Tp, Tz, SST, Direction, Current Speed, Current Direction
                    Caloundra,54,1713621600,2024-04-21T00:00:00,-26.84552,153.15474,0.646,1.150,10.530,4.040,24.70,75.90,-99.90,-99.90
    ...
    @Test
    public void extractsWaveInfoFromCsvSimilarHeight() throws IOException, CsvException {
        String waveCsvData = """
                    Wave Data provided @ 02:15hrs on 28-04-2024
                    Site, SiteNumber, Seconds, DateTime, Latitude, Longitude, Hsig, Hmax, Tp, Tz, SST, Direction, Current Speed, Current Direction
                    Caloundra,54,1713621600,2024-04-21T00:00:00,-26.84552,153.15474,0.646,1.150,10.530,4.040,24.70,75.90,-99.90,-99.90
    ...
    public void throwsExceptionOnEmptyCsv() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> WaveInfoExtractor.extractWaveInfo(""));
    ...
    public void throwsExceptionOnInvalidCsv() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> WaveInfoExtractor.extractWaveInfo(invalidWaveCsvData));
        assertEquals("Failed to extract wave information from input.", exception.getMessage());
